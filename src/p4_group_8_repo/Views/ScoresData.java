...
/**
 * This class facilitates the fetching of data from the Scores file. </br>
 * It uses a String Property as the scores, stored as strings,
 * will be observed by the table view in the EndScreenView class
 * and the table should be able to read those values and sort them accordingly.
 */
public class ScoresData {
    /**
     * instantiating and declaring a StringProperty scores
     */
